function pathnames = proteomaps_path_names(data_directory,hierarchy_version)

if ~exist('hierarchy_version','var'),
  pathnames.hierarchy_version = 'KO_gene_hierarchy_2015-01-01';
end

pathnames.BASE_DIR              = [fileparts(which(mfilename)) filesep '..' filesep '..' filesep '..' filesep];
pathnames.PROTEIN_LENGTH_DIR    = [pathnames.BASE_DIR 'genomic_data/' pathnames.hierarchy_version '/protein_length_data/'];
