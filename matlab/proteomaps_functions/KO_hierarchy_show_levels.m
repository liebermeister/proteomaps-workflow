...
table(ko_tree_1,0,'KO_gene_hierarchy_level_1_DO_NOT_EDIT.tms')
table(ko_tree_2,0,'KO_gene_hierarchy_level_2_DO_NOT_EDIT.tms')
table(ko_tree_3,0,'KO_gene_hierarchy_level_3_DO_NOT_EDIT.tms')
