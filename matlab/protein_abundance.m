function protein_abundance(data_directory,n_randomised_trees,pathnames)
...
protein_lengths = 0;
protein_abundance_branch_ratios(data_directory,data_sets,protein_lengths,pathnames);
