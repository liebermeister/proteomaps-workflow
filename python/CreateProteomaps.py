...
def CreateProteomaps(data_dir, paver_files_directory, n_annotation_subsampling, hierarchy_version, verbose):
    ...
    print("Please run Matlab commands:\n addpath(genpath('" + MATLAB_PATH + "'));\n BASE_DIR = '" + pn.BASE_DIR + "';\n TMP_DIR = '" + pn.TMP_DIR  + "';\n RESOURCE_DIR = '" + pn.PROTEIN_HIERARCHY_DIR  + "';\n data_directory = '" + data_dir + "';\n show_protein_colormap;\n n_randomised_trees = " + str(n_annotation_subsampling) + ";\n protein_abundance;")
...
if __name__ == '__main__':
    ...
    CreateProteomaps(data_dir, paver_files_directory, n_annotation_subsampling, hierarchy_version, verbose)
