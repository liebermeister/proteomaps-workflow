...
for data_file_triple in data_files:
    ...
    outfile = data_dir + "/" + data_file_triple[2] + "/" + my_data_set + ".csv"
    print "Writing file " + outfile
    fo_abundance = open(outfile,"w")
    fo_abundance.write("Systematic name\tAbundance (data value)\tAbundance [ppm]\tSize-weighted abundance\tSize-weighted abundance [ppm]\tSize\tGene name\tKO number\tKO category\n")
