...
rectangle_all = [0 1 0 1]; % left right bottom top
rectangles    = treemap_hierarchical(rectangle_all,names,summed_sizes,colors,levels,split_direction);

figure(1); clf; 
treemap_plot(levels,names,rectangles,colors);
