function colormap_table = make_protein_colormap(infile,outfile,colorfile,show_graphics)

% make_protein_colormap(infile,outfile,colorfile,show_graphics)
% 
% generate proteomaps colormap and save if to file (function argument 'outfile')
% 
% typical settings for filenames: 
...
ko_tree = load_file_as_strings(infile);
...
colormap_table = [ko_list,num2cell(V(:,1)),num2cell(V(:,2)),num2cell(V(:,3))];

mytable(colormap_table,0,outfile);
